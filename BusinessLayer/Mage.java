...
public class Mage extends Player{
    ...
    public String attack(List<Enemy> enemiesAttacked) {
        if(this.getCurrentMana() < this.getManaCost())
            return "there are no enough mana points to use the special ability" + "\r\n";
        ...
        while (this.getHitsInAttack() < this.getHitsCount())
        {
            ...
            {
                toReturn += "there's no enemies to attack" + "\r\n";
                return toReturn;
            }
    ...
    public String getState() {
        if (this.getHealthAmount() != 0)
            return "name: " + this.getName() + " health: " +  this.getHealthAmount() + "/" + this.getHealthPool() + " attack points: " + this.getAttackPoints() +
                    " defece points: " + this.getDefencePoints() + "\r\n" + "mana: " + this.getCurrentMana() + "/" + this.getManaPool() +
                    " mana cost: " + this.getManaCost() + " spell power: " + this.getSpellPower() + " ability range: " + this.getAbilityRange() + "\r\n";
        else
